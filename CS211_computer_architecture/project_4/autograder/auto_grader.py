...
def run_command(command_string, input_string="", max_lines=0, timeout=5, verbose=False, echo=False, throw_exception=True, return_valgrind_output=False, user_program=False):
    #print timeout
...
#                print "result file is " + resultfile
            ...
            if resultfile[len(resultfile)-5] == "1" :
                ...
                try:
                    run_command("./%s 1024 assoc:4 fifo 16 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    #print "my score is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc:2 fifo 8 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    #print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 1024 assoc:4 fifo 1 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    #print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 2048 assoc:4 lru 8 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    #print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 32 assoc lru 4 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    #os.chdir(prevdir)
                    #print "myScore is ", myscore
