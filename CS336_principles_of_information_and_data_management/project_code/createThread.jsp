...
<form method="post" action="actuallyCreateThread.jsp">
Subject: <input type="text" name="subject" maxlength=44> <br> <br>
Content: <br>
<textarea rows="5" cols="50" maxlength=224 name="content">
</textarea><br><br>
