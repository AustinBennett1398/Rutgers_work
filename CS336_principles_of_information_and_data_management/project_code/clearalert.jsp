...
ResultSet rs12;
int valid = 1;
st12.executeUpdate("delete from alert where username = " + "'" + username + "' and valid =" + "'" + valid + "'");

out.println("all existing alerts have been deleted, any pending alerts you have created will remain.");
